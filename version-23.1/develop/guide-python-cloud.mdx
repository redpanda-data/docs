---
title: Build a Chat Room Application with Redpanda Cloud and Python
linkRoot: ../../
deployment: Cloud
contextLinks:
  - name: 'Docker'
...
<head>
    <meta name="title" content="Build a Chat Room Application with Redpanda Cloud and Python | Redpanda Docs"/>
    <meta name="description" content="Create a basic chat room application with Redpanda Cloud and Kafka clients developed with kafka-python"/>
    <link rel="canonical" href="https://docs.redpanda.com/docs/develop/guide-python-cloud/" />
</head>
