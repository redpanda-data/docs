...
<head>
    ...
    <link rel="canonical" href="https://docs.redpanda.com/docs/develop/http-proxy/" />
</head>
...
The first step is to deploy Redpanda. See the [Redpanda Quickstart](../../get-started/quick-start) for more information.
...
--
:::note
This is based on the assumption that you're in the root directory of an existing NodeJS project. See link:../../develop/guide-nodejs[Use NodeJS with Redpanda] for one way to get started with a new NodeJS project and examples of connecting to Redpanda with a native library.
:::
