...
You can check which IPs this range encompasses by using either the [ipcalc](https://www.linux.com/topic/networking/how-calculate-network-addresses-ipcalc/) command in your terminal or the [CIDR calculation tool](https://www.ipaddressguide.com/cidr). For example, if your client's CIDR range is 10.0.0.0/20, run: 
...
Ranges like `10.0.0.6/20`, `10.0.8.0/20`, or `10.0.1.7/20` would not work. You can use [ipcalc](http://trk.free.fr/ipcalc/tools.html) to check for overlapping IPs. 
