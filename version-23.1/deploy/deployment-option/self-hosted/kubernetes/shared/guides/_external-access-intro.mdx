...
:::tip
In a production environment, it's best practice to use ExternalDNS to manage DNS records for your brokers. See [Use ExternalDNS for external access](../kubernetes-best-practices#use-externaldns-for-external-access).
:::
