...
<head>
  <meta name="title" content="rpk cluster config export | Redpanda Docs" />
  <meta name="description" content="rpk cluster config export" />
  <link rel="canonical" href="https://docs.redpanda.com/docs/reference/rpk/rpk-cluster/rpk-cluster-config-export/" />
</head>
...
|-f, --filename |string |path to file to export to, for example
` ./config.yml`
