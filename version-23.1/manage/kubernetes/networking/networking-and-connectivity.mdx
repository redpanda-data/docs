...
<head>
    ...
    <link rel="canonical" href="https://docs.redpanda.com/docs/manage/kubernetes/networking/networking-and-connectivity/" />
</head>
...
![Fully qualified domain name for a Pod called redpanda-0 in the redpanda namespace](/img/headless-clusterip-dns.png)
...
![A client connects to a Pod directly through the NodePort Service or indirectly through the load balancer](/img/nodeport-loadbalancer.png)
