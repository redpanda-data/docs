...
This repository hosts the documentation content for Redpanda Enterprise.
...
Versioned content is stored in branches that track the version of Redpanda Enterprise. Production branches use the *v/x.y* naming pattern. For example, branch `v/22.3` hosts the content for version 22.3.x of Redpanda Enterprise. The `main` branch always contains docs for the latest release.
