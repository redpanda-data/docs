...
The [`leader_balancer_mode`](../../../reference/cluster-properties/#leader_balancer_mode) property ensures that each shard in a cluster has an equal number of partitions. It determines the movement of leadership for the replica set of a partition. It supports two modes:
