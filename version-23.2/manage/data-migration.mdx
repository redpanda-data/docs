...
<head>
    ...
    <link rel="canonical" href="https://docs.redpanda.com/docs/manage/data-migration/" />
</head>
...
- 2 Redpanda clusters - You can set up these clusters in any deployment you like, including [Kubernetes](../../deploy/deployment-option/self-hosted/kubernetes/get-started-dev), [Docker](../../get-started/quick-start), and [Linux](../../deploy/deployment-option/self-hosted/manual).
