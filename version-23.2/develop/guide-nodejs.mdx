---
title: Build a Chat Room Application with Redpanda and Node.js
linkRoot: ../../
deployment: Docker
contextLinks:
  - name: 'Docker'
...
<head>
    <meta name="title" content="Build a Chat Room Application with Redpanda and Node.js | Redpanda Docs"/>
