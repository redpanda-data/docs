...
<head>
    ...
    <meta name="description" content="The rpk application is a single binary that provides a way to interact with your Redpanda clusters from the command line. "/>
