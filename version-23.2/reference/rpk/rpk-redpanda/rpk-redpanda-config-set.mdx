...
<head>
  <meta name="title" content="rpk redpanda config set | Redpanda Docs" />
  <meta name="description" content="rpk redpanda config set" />
  <link rel="canonical" href="https://docs.redpanda.com/docs/reference/rpk/rpk-redpanda/rpk-redpanda-config-set/" />
</head>
