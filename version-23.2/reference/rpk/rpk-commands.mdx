...
The `rpk` commands feature autocompletion, so that you can write the first few letters that uniquely identify a command and then use the tab key to complete it. For more information, see [rpk autocompletion documentation](../../rpk/rpk-generate/rpk-generate-shell-completion).
