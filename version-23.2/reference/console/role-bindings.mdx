...
<head>
    <meta name="title" content="Console role-binding configuration template | Redpanda Docs"/>
    <meta name="description" content="Console role-binding configuration template with properties description."/>
    <link rel="canonical" href="https://docs.redpanda.com/docs/reference/console/role-bindings/" />
</head>
