...
|--console-image |string |An arbitrary Redpanda Console container image to use (default "redpandadata/console:v3.5.1").
...
|--image |string |An arbitrary Redpanda container image to use (default "redpandadata/redpanda:v26.1.0-dev").
