...
The amount of time between invocations of the datalake disk space usage monitor which examines disk usage and dispatches requests to translators to reduce their usage if it is above the configured threshold.
