...
The superuser can grant permissions to additional users through access control lists (ACLs). For details on how ACLs function in Redpanda, see the link:/docs/22.1/reference/rpk-commands//#rpk-acl[rpk acl reference] documentation.
...
Now that you have your superuser and additional users that can interact with the cluster, you can use the link:/docs/22.1/reference/rpk-commands/[rpk reference] documentation to experiment with the `rpk` commands and create additional users and ACLs.
...
Use the link:/docs/22.1/reference/rpk-commands/[rpk reference] documentation to experiment with the `rpk` commands and when you're ready to clean up the cluster from the brontosaurus tutorial, run this command:
