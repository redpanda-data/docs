...
| Operator v25.1.x
| Deploying multiple instances of the Redpanda Operator in a single Kubernetes cluster is deprecated as of v25.1.x. Only one Operator instance per cluster is supported. See xref:deploy:redpanda/kubernetes/k-production-deployment.adoc[].
