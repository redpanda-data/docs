...
| Security flags have been moved into the global `-X` flag. While the old ones still work, its recommended that you use the new format. See xref:reference:rpk/rpk-x-options.adoc[`rpk -X`] for details. 
