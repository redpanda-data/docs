...
This guide provides step-by-step instructions for migrating from Redpanda Console v2.x.x (v2) to v3.x.x (v3). The new release introduces a unified authentication and authorization system along with several breaking changes. This guide helps you understand the changes and provides examples to help you update your configuration.
