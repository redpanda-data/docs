...
NOTE: Make sure your users are provisioned as SASL/SCRAM users in Redpanda before enabling user impersonation.
...
NOTE: Make sure your users are provisioned as SASL/OAUTHBEARER users in Redpanda. Use this user to authenticate with Redpanda Console.
