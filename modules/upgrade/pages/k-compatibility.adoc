...
Release notes: https://github.com/redpanda-data/redpanda-operator/releases

[cols="4*m"]
|===
| Redpanda Operator Helm Chart | Redpanda Operator|CRD | Latest supported Redpanda Helm Chart
