...
The recommended approach is to maintain your current version of the Redpanda Helm chart and regularly update the Redpanda Operator. When the Redpanda Operator is updated, it will manage the Helm chart upgrades in a way that maintains compatibility and ensures smooth operation of your Redpanda clusters.
