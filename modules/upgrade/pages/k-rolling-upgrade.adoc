...
A rolling upgrade involves running the following procedure on each broker, one at a time. The Redpanda Helm chart and the Redpanda Operator automate this procedure.
