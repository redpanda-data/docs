...
====
+
Here, `redpanda-0` is running a broker with the ID `0`. In this example, the ordinal of the StatefulSet replica is the same as the broker's ID. However, this is not always the case.
