...
NOTE: If you use the Redpanda Operator, consider using the xref:upgrade:k-migrate-node-pools.adoc[NodePool CRD] for automated blue/green migration instead of the manual process described here.
