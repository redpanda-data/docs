...
** Redpanda v25.3 introduces breaking schema changes for Iceberg topics. Before upgrading, review xref:manage:iceberg/iceberg-schema-changes-and-migration-guide.adoc[] and follow the required migration steps to avoid data loss or query errors for your Iceberg topics.
