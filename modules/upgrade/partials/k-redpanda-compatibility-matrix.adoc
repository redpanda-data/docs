...
| link:https://artifacthub.io/packages/helm/redpanda-data/redpanda/5.8.13[5.8.x]
| link:https://github.com/redpanda-data/redpanda/releases/[24.1.x], link:https://github.com/redpanda-data/redpanda/releases/[23.3.x]
| 1.21.0-0
| 3.10.0
