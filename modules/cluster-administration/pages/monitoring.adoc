...
For details about the command, refer to the link:../reference/rpk/rpk-generate/rpk-generate-grafana-dashboard.mdx[rpk generate grafana-dashboard] reference.
