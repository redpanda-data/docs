...
== Connecting Console to Redpanda Clusters with TLS
...
Console will now connect securely to your Redpanda cluster using TLS. For production, set `insecureSkipTlsVerify: false` and use a trusted CA.
