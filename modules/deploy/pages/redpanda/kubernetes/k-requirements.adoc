...
:tags: ["Kubernetes"]
:page-aliases: deploy:deployment-option/self-hosted/kubernetes/cloud-instance-local-storage.adoc, deploy:deployment-option/self-hosted/kubernetes/kubernetes-requirements-index.adoc, deploy:deployment-option/self-hosted/kubernetes/kubernetes-cluster-requirements.adoc, deploy:deployment-option/self-hosted/kubernetes/k-requirements.adoc
:env-kubernetes: true
...
- xref:deploy:redpanda/kubernetes/k-production-readiness.adoc[Validate production readiness] with the comprehensive checklist
...
+
--
** https://cloud.google.com/compute/docs/disks/local-ssd[Local SSDs^]
