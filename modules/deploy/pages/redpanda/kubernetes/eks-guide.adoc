...
- Sufficient CPU: Redpanda requires at least 4 full CPU cores per broker. The c5d.2xlarge instance provides 8 vCPUs, which comfortably meets this requirement.
