...
:page-aliases: deploy:deployment-option/self-hosted/kubernetes/eks-guide.adoc
:env-eks:
:env-kubernetes: true
...
- Sufficient CPU: Redpanda requires at least 2 full CPU cores per broker. The c5d.2xlarge instance provides 8 vCPUs, which comfortably meets this requirement.
