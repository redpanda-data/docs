= Shadowing Setup and Configuration
:description: Learn to configure Redpanda Shadowing's disaster recovery capabilities, including cross-region replication, data filters, networking, and authentication setup.
:env-linux: true
