...
[IMPORTANT]
====
This is an emergency procedure. For planned failover testing or day-to-day shadow link management, see xref:./failover.adoc[Planned Failover]. Ensure you have completed the disaster readiness checklist in xref:./index.adoc#disaster-readiness-checklist[Disaster Recovery Overview] before an emergency occurs.
====
