...
For comprehensive installation and configuration instructions, see xref:deploy:console/linux/deploy.adoc[Deploy Redpanda Console on Linux].
...
For instructions on starting and managing Redpanda Console, see xref:deploy:console/linux/deploy.adoc[].
