...
:page-aliases: deploy-self-hosted:production-deployment.adoc, deployment:custom-deployment.adoc, deployment:production-deployment.adoc, deploy:deployment-option/self-hosted/manual/production/production-deployment.adoc
:env-linux: true
...
Make sure you meet the xref:deploy:redpanda/manual/production/requirements.adoc[hardware and software requirements].
...
For comprehensive installation and configuration instructions, see xref:console:deployment/linux.adoc[Deploy Redpanda Console on Linux].
...
For instructions on starting and managing Redpanda Console, see xref:console:deployment/linux.adoc#deploy-as-systemd-service[Deploy as systemd Service].
