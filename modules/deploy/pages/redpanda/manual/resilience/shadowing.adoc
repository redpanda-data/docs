...
The failover process is irreversible. Once topics are promoted, they cannot return to shadow mode, and automatic fallback to the original source cluster is not supported.
...
Monitoring your shadow links ensures proper replication performance and helps you understand your disaster recovery readiness. Use rpk commands, metrics, and status information to track shadow link health and troubleshoot issues.
