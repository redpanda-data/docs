...
----
image:
  repository: "redpandadata/connectors"
  tag: "1.2.3"
----
...
. Access Redpanda Console through port-forward:
+
[,bash]
----
...
If the Connectors page shows "No clusters configured" or connection errors, verify your Redpanda Console configuration includes the correct Kafka Connect service URL.
