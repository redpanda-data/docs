= Configure Connectors with Docker Image
:description: Connectors self-hosted docker image.
...
services:
  connect:
    ...
    environment:
      ...
      CONNECT_BOOTSTRAP_SERVERS: 0.rp-5a2fa75.data.dev.vectorized.cloud:30499,1.rp-5a2fa75.data.dev.vectorized.cloud:30499,2.rp-5a2fa75.data.dev.vectorized.cloud:30499
