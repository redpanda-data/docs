...
Redpanda Data recommends using locally attached NVMe devices with an XFS filesystem for the Redpanda data directory. NVMe devices offer high IOPS and minimal latency, while XFS offers enhanced performance with Redpanda workloads.
