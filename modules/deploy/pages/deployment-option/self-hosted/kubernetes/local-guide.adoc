...
:page-aliases: getting-started:kubernetes-qs-local-access.adoc, getting-started:kubernetes-qs-minikube.adoc, quickstart:kubernetes-qs-local-access.adoc, quickstart:kubernetes-qs-minikube.adoc
