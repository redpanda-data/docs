...
- xref:reference:k-crd.adoc#k8s-api-github-com-redpanda-data-redpanda-operator-api-redpanda-v1alpha2-redpandaclusterspec[`spec.clusterSpec`]: This is where you can override default values in the Redpanda Helm chart. For other configuration details, see <<Production considerations>>.
...
- `spec.clusterSpec.statefulset`: For configuration details, see <<Production considerations>>.
