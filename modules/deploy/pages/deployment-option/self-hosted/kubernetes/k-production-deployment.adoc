...
WARNING: Your existing versions of Flux controllers and Flux CRDs must match the versions that comes with the Redpanda Operator. You can find these version on https://github.com/redpanda-data/redpanda-operator/blob/main/src/go/k8s/go.mod#L12-L17[GitHub].
=====
