...
:page-aliases: platform:getting-started/quick-start-kubernetes.adoc, platform:getting-started/kubernetes-qs-cloud.adoc, platform:quickstart/kubernetes-qs-cloud.adoc
