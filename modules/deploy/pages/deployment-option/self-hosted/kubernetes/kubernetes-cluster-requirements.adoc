...
:tags: ["Kubernetes"]
:page-aliases: deploy:deployment-option/self-hosted/kubernetes/cloud-instance-local-storage.adoc, deploy:deployment-option/self-hosted/kubernetes/kubernetes-requirements-index.adoc
:page-context-links: [{"name": "Linux", "to": "deploy:deployment-option/self-hosted/manual/production/requirements.adoc" },{"name": "Kubernetes", "to": "deploy:deployment-option/self-hosted/kubernetes/kubernetes-cluster-requirements.adoc" } ]
:env-kubernetes:
