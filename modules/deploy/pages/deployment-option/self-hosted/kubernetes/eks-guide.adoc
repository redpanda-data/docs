...
You need `eksctl` to create an EKS cluster. [Install `eksctl`](https://docs.aws.amazon.com/eks/latest/userguide/eksctl.html).

=== jq

You need jq to parse JSON results and store the value in environment variables. [Install jq](https://stedolan.github.io/jq/download/).
