...
In this step, you create an EKS cluster with three nodes on https://aws.amazon.com/ec2/instance-types/c5/[`c5d.2xlarge` instance types]. Deploying three nodes allows your EKS cluster to support a Redpanda cluster with three brokers. This `c5d.2xlarge` instance type comes with:
