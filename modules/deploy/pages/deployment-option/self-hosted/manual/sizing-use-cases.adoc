...
The following scenarios provide estimates and advice for sizing Redpanda clusters for different throughput and retention use cases in your data center and in the cloud. For details about sizing considerations, see xref:./sizing.adoc[Sizing Guidelines].
