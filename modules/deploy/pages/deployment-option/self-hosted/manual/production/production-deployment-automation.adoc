...
Redpanda console can be installed by adding the redpanda_broker role to a group with install_console: true. The standard playbooks will automatically install console on hosts in the [client] group. 
