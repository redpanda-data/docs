...
contained in your own environment. This provides an additional layer of security and isolation. When you create a BYOC cluster, you select a xref:deploy:deployment-option/cloud/tiers.adoc[throughput tier and region] on either AWS or GCP. Redpanda handles provisioning, operations, and maintenance. See also: <<BYOC architecture>>.
