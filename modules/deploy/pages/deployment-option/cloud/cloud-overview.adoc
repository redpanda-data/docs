...
With Serverless, you only pay for what you consume, without any commitment. A cluster is created in under one second, so you can surface it in your applications (for example, for tenant isolation). As your workload increases, you can migrate a Serverless cluster to a Dedicated or BYOC cluster.
