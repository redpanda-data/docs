...
The Redpanda Cloud shared responsibility model outlines the security responsibilities for Redpanda and customers. Responsibilities depend on the type of deployment. 
