...
The Redpanda Cloud shared responsibility model outlines the security responsibilities between Redpanda and customers. The shared responsibility model depends on the type of deployment. 
