...
You can manage secure user access to Redpanda Cloud with single sign-on. Redpanda uses OIDC to delegate the authentication process to an external identity provider (IdP), such as Okta.
