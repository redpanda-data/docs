...
NOTE: Serverless clusters are not deployed on tiers. See xref:deploy:deployment-option/cloud/serverless.adoc#limits[Serverless limits]. To change your cluster type, contact https://support.redpanda.com/hc/en-us/requests/new[support^].
