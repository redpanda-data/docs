...
When you create a Dedicated cluster, you select the xref:deploy:deployment-option/cloud/dedicated/dedicated-tiers.adoc[throughput tier] that meets your compute and storage needs. 
...
contained in your own environment. This provides an additional layer of security and isolation. When you create a BYOC cluster, you select the xref:deploy:deployment-option/cloud/byoc-tiers.adoc[throughput tier] that meets your compute and storage needs. Redpanda handles provisioning, operations, and maintenance. See also: <<BYOC architecture>>.
