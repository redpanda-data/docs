...
To start using BYOC, sign up in Google Cloud Marketplace or AWS Marketplace, and you can view invoices and manage your subscription in the marketplace. Or, contact https://redpanda.com/try-redpanda?section=enterprise-trial[Redpanda sales^] to request a private offer, and you are billed directly. 
