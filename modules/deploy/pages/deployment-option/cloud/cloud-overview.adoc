...
The Redpanda Cloud shared responsibility model depends on the type of deployment. 

|=== 
| Resource | Dedicated: Redpanda | Dedicated: Customer | BYOC: Redpanda | BYOC: Customer | BYOC with customer-managed VPC: Redpanda | BYOC with customer-managed VPC: Customer
