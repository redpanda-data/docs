...
To start using Dedicated, sign up for a free trial on the AWS Marketplace. New trials receive $300 (USD) in free credits to spend in the first 30 days. This should be enough to run Redpanda with reasonable throughput. No credit card is required for a trial. To continue using Dedicated, add a credit card and pay as you go.
