...
The Redpanda Cloud shared responsibility model provides the security ownership areas for Redpanda and customers. Responsibilities depend on the type of deployment. 
