...
:description: Redpanda supports Serverless, with multi-tenant clusters running in Redpanda Cloud; Dedicated, with single-tenant clusters running in Redpanda Cloud; and Bring Your Own Cloud (BYOC), with clusters running in your private cloud.
...
* <<Serverless>>: Multi-tenant clusters are hosted in Redpanda Cloud. This is the fastest and easiest way to start data streaming in the cloud. With pay-as-you-go billing, you only pay for what you consume.
...
With Serverless clusters, you host your data in Redpanda's VPC, and Redpanda handles provisioning, operations, and maintenance. Serverless clusters are multi-tenant deployments, which means that your data is hosted on Redpanda clusters that are shared among multiple tenants. Other tenants never access your data, and your data never leaves your selected region. 
