...
With Serverless clusters, you host your data on Redpanda's cloud resources (AWS), and Redpanda handles automatic scaling, provisioning, operations, and maintenance. This is a production-ready deployment option with a cluster available instantly. This is no base cost, and with pay-as-you-go billing after the free trial, you only pay for what you consume. 
...
When you create a Dedicated cluster, you select the supported xref:deploy:deployment-option/cloud/dedicated/dedicated-tiers.adoc[throughput tier] that meets your compute and storage needs. 
...
contained in your own environment. This provides an additional layer of security and isolation. When you create a BYOC cluster, you select the supported xref:deploy:deployment-option/cloud/byoc-tiers.adoc[throughput tier] that meets your compute and storage needs. Redpanda handles provisioning, operations, and maintenance. See also: <<BYOC architecture>>.
