...
To start using Dedicated, sign up for a free trial on the AWS Marketplace. New trials receive $300 (USD) in free credits to spend in the first 30 days. After the 30 days or the credits expire, you can continue using your Dedicated cluster without any commitment, only paying for what you consume.
