...
The Redpanda Cloud shared responsibility model outlines the security responsibilities for customers. The shared responsibility model depends on the type of deployment. 
