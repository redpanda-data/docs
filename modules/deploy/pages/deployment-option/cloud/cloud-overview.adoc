...
NOTE: With BYOC, Redpanda manages security policies and resources, including subnetworks, service accounts, IAM roles, firewall rules, and storage buckets. If you want additional security, you can manage these resources yourself. See xref:./vpc-byo-gcp.adoc[].
