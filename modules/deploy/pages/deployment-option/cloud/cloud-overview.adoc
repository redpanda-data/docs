...
* <<Serverless>>: Clusters hosted in Redpanda Cloud. This is the fastest and easiest way to start data streaming in the cloud. 
...
To start using BYOC, contact https://redpanda.com/try-redpanda?section=enterprise-trial[Redpanda sales^] to request a private offer, and you can be billed directly or through Google Cloud Marketplace or AWS Marketplace. 
...
When you create a cluster, you select a throughput tier. The following table lists the current cluster-level AWS and GCP tier limits. Legacy tiers may have different limits. For more information, contact https://support.redpanda.com/hc/en-us/requests/new[support^]. 
