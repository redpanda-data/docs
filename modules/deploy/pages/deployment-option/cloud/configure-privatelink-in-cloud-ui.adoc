= Configure PrivateLink in the Cloud UI
...
* PrivateLink does not limit the number of VPC connections.
* You control which AWS resources are allowed to connect to the service.
...
In **Cluster settings**, click **Disable**. Existing connections are closed immediately. To connect via PrivateLink again, you'll have to reenable the service.
