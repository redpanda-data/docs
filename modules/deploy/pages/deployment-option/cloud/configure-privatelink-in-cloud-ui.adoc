...
In **Cluster settings**, click **Disable**. Existing connections are closed after the AWS PrivateLink service is disabled. To connect with PrivateLink again, you must re-enable the service.
