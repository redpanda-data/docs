...
. On https://aws.amazon.com/marketplace[AWS Marketplace^], search for and select "Redpanda".

. On the *Redpanda Cloud - Fully Managed Redpanda* overview page, click **Subscribe**.
+
[NOTE]
====
