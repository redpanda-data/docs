...
With a usage-based billing commitment, you sign up for a monthly or an annual minimum spend amount. This allows you to subscribe to Redpanda Cloud through Google Cloud Marketplace to quickly provision Redpanda Dedicated clusters. 
