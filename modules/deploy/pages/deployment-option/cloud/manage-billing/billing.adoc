...
When you subscribe to Redpanda Cloud through Google Cloud Marketplace or AWS Marketplace, you can use your existing marketplace billing and credits to provision Redpanda Dedicated Cloud clusters. View your bills and manage your subscription directly in your marketplace. You can either pay as you go or purchase through committed use. 
