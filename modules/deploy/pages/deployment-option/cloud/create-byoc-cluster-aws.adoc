...
====
+ 
Optionally, click *Advanced settings* to specify up to 5 key/value custom tags. After the cluster is created, the tags are applied to all AWS resources associated with this cluster. 
