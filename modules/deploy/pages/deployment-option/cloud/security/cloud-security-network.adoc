...
* Time synchronization
+
To ensure time synchronization, Redpanda Cloud in Azure uses https://learn.microsoft.com/en-us/azure/virtual-machines/windows/time-sync[Microsoft time sync^].
