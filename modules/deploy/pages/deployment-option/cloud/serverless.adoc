...
After you click to start the trial, Redpanda instantly prepares an account for you. Your account includes a `welcome` cluster and a `hello-world` topic in AWS you can explore. 
