...
To start using Redpanda Serverless, join the free trial. Each trial supports five Serverless clusters. If you want to continue after the trial ends, you can enter a credit card and pay as you go. 
