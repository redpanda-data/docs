...
[NOTE]
====
These baseline limits are subject to change after the limited availability release. To increase your limits, contact https://support.redpanda.com/hc/en-us/requests/new[support^]. 
====

Each Redpanda Cloud account has the following limits:
...
New trials receive 100 free credits to spend in the first 14 days. No credit card is required. This should be enough to run Redpanda with reasonable throughput. One credit equals one US dollar (USD). 
