= Cast (Apache)
:description: How to set Cast (Apache) Single Message Transform for a connector.
:page-cloud: true

Cast (Apache) SMT lets you change the data type of fields in a Redpanda message, updating the schema if one is present.
