...
== Prerequisites
* Valid credentials with `read` role to access the MongoDB database. For more granular access, you need to allow
`find` and `changeStream` actions to specific databases/collections.
