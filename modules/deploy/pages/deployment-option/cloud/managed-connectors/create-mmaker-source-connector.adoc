...
| The target server is not able to receive message because it is too large in size. Disabled compression can be a root cause. Consider enabling compression: `"Compression type": "snappy",`
