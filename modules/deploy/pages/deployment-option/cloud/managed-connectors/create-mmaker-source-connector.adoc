...
| `Offset lag max`
| `offset.lag.max`
| How out-of-sync a remote partition can be before it is resynced. It has impact on the MirrorMaker2 Checkpoint connector - it is the maximum lag for syncing consumer groups. The default is 100.
|===
