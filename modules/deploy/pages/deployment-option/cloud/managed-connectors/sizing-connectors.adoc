...
[NOTE]
====
Connectors tasks limit depends on the cluster tier.

Contact https://support.redpanda.com/hc/en-us/requests/new[Redpanda support^] if you need to configure more than 500 tasks per cluster. 
====
