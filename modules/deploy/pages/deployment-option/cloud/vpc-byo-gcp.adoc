...
Log in to the https://cloud.redpanda.com[Redpanda Cloud UI^], and follow the steps to xref:./create-byoc-cluster-gcp.adoc[create a BYOC cluster], with the following exceptions:
