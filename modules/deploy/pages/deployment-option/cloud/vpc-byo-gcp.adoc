...
+
The account ID of the GCP service account is used to configure service account findings. This account ID is the local part of the email address for the GCP service account.
