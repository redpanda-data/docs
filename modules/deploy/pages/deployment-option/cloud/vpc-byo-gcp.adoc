...
. In a previous step, you started to create a BYOC cluster in the Redpanda Cloud UI, stopping just before the Validation step. With *customer-managed* networks, you must grant the user deploying the cluster with `rpk` the following permissions. 
+
.Expand permissions
[%collapsible]
====
