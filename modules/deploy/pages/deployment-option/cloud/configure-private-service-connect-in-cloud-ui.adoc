...
In **Cluster settings**, click **Disable**. Existing connections are closed immediately. To connect using the Private Service Connect again, you must re-enable the service.
