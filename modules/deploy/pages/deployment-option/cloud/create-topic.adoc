...
NOTE: Running Redpanda Cloud topics with a replication factor of one is _not_ recommended. If you do so, and data is lost, Redpanda is unable to assist with recovery.
