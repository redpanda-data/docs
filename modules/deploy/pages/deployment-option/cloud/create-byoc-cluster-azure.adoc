...
+
** Resources: For more information, see the https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/resource-providers-and-types[Microsoft documentation].
+
*** Microsoft.Compute
