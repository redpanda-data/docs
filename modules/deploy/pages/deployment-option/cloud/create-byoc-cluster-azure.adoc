...
+
** Quotas: A Redpanda cluster requires the following quotas. For more information, see the https://learn.microsoft.com/en-us/azure/quotas/view-quotas[Microsoft documentation].
+
