...
* Serverless: you must https://redpanda.com/try-redpanda/cloud-trial#serverless[sign up for a trial^] of Redpanda Serverless. See xref:deploy:deployment-option/cloud/serverless.adoc[Serverless] to learn about the limited availability (LA) release, including cluster limits, trial credits, and supported features.
