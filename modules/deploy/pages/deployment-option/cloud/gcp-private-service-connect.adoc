...
+
Set the following environment variables. Variables with a `BYOVPC_` prefix represent resources that should have been created previously as part of the BYOVPC process.
+
--
