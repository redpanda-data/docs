...
+
Enter a cluster name, then select the namespace, cloud provider (AWS or GCP), xref:deploy:deployment-option/cloud/dedicated/dedicated-tiers.adoc[region, availability zone type (single AZ or multi AZ), zones], and Redpanda version.
+
[NOTE]
====
