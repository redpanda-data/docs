...
====
+ 
Optionally, click *Advanced settings* to specify up to 5 key/value custom labels. After the cluster is created, the labels are applied to all GCP resources associated with this cluster. 
