...
+
Enter a cluster name, then select the namespace, provider (GCP), xref:deploy:deployment-option/cloud/byoc-tiers.adoc[region, availability zones, tier], and Redpanda version.
+
[NOTE]
====
