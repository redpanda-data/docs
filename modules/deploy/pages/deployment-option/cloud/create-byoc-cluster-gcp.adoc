...
. Click *Next*.
. On the Network page, enter the connection type: either *Public*, *Private*, or *Customer-Managed*. For BYOC clusters, *Private* is best-practice.
...
- xref:./vpc-byo-gcp.adoc[Add a BYOC Customer-Managed VPC on GCP]
