...
Redpanda Cloud has a simplified navigation, with clusters and networks available at the top level. This provides a global view of all the resources in your organization. Namespaces are now called glossterm:resource group[,resource groups], although the functionality remains the same.
