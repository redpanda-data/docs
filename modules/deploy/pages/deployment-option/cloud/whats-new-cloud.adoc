...
Redpanda now supports xref:deploy:deployment-option/cloud/create-byoc-cluster-azure.adoc[BYOC clusters on Azure]. This is a limited availability release for BYOC clusters. 
