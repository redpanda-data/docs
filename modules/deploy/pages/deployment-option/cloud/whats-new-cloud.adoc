...
Redpanda Cloud now supports usage-based billing for Dedicated Cloud clusters. Contact https://redpanda.com/try-redpanda?section=enterprise-trial[Redpanda sales^] to request a private offer for monthly or annual committed use. After you receive your private offer, you can use existing marketplace credits to quickly provision Dedicated Cloud clusters, and you can view your bills and manage your subscription directly in Google Cloud Marketplace or AWS Marketplace.
