...
As part of Redpanda Cloud's simplified navigation, _namespaces_ have been renamed to _resource groups_. 
...
The *Clusters* page now lists the clusters in all of your resource groups, and the *Networks* page now lists the networks in all of your resource groups. 
