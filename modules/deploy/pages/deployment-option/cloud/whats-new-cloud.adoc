...
=== Usage-based billing commitments

You can now sign up for a monthly or an annual usage-based billing commitment to Redpanda Cloud through Google Cloud Marketplace or AWS Marketplace. You can use existing marketplace credits to quickly provision Dedicated Cloud clusters, and you can view your bills and manage your subscription directly in the marketplace.  
