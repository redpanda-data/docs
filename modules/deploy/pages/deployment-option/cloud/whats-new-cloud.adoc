...
=== Higher connection limits for cloud tiers

The number of supported client connections has increased for all xref:deploy:deployment-option/cloud/byoc-tiers.adoc[cloud tiers]. For example, tier 1 now supports 9,000 maximum connections, and tier 9 supports 450,000 maximum connections. 
