...
As part of Redpanda Cloud's simplified navigation, namespaces now are called glossterm:resource group[resource groups]. The functionality is the same, but now the *Clusters* page lists clusters in all of your resource groups, and the *Networks* page lists networks in all of your resource groups. 
