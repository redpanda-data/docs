...
The xref:deploy:deployment-option/cloud/terraform-provider.adoc[Redpanda Terraform provider] lets you can create and manage Redpanda resources, such as clusters, topics, users, ACLs, networks, and resource groups.
