...
=== Namespaces renamed resource groups

Redpanda Cloud has a new flattened hierarchy for easier navigation. As part of this simplification, namespaces now are called glossterm:resource group[,resource groups]. The functionality is the same, but now the *Clusters* page lists the clusters in all of your resource groups, and the *Networks* page lists the networks in all of your resource groups. 
