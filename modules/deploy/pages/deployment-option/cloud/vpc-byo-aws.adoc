...
* Minimum permissions in that AWS project. For reference, the following actions are required for the user who will create the cluster with `rpk cloud byoc aws apply`: 
+
