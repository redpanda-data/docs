...
You will need to configure the appropriate terraform script for your cloud provider. Within the deployment-automation project, locate the file for your cloud of choice and edit the availability_zones parameter. For example, under AWS, you will edit the `aws/main.tf` file:
