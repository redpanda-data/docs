...
When you create a BYOC cluster, you select the throughput tier for your compute and storage needs. The following table lists the supported tiers for BYOC clusters. 
...
When you create a Dedicated cluster, you select the throughput tier for your compute and storage needs. The following table lists the supported tiers for Dedicated clusters. 
