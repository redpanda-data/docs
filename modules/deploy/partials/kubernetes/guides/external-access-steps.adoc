...
[,bash]
----
rpk topic describe twitch-chat -X tls.enabled=true -X tls.ca=ca.crt -X user=redpanda-twitch-account -X pass=changethispassword -X sasl.mechanism=SCRAM-SHA-256
----
+
.Expected output:
[%collapsible]
