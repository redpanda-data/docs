...
NOTE: This guide is for configuring AWS PrivateLink using the Redpanda Cloud API. See xref:configure-privatelink-in-cloud-ui.adoc[Configure PrivateLink in the Cloud UI] if you want to set up the endpoint service using the UI.
...
include::networking:partial$cloud/private-links-access-rp-services-through-vpc.adoc[]
...
include::networking:partial$cloud/private-links-test-connection.adoc[]
