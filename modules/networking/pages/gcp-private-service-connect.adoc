...
. Update the Redpanda Cloud Agent IAM role. This step is required only for clusters with xref:xref:get-started:cluster-types/byoc/vpc-byo-gcp.adoc[customer-managed resources].
+
