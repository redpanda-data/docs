...
Use these guides to diagnose and troubleshoot issues in a Redpanda cluster using recommended tools and diagnostic tests.
...
To confirm your cloud storage is configured correctly for Tiered Storage, use the self-test command.
