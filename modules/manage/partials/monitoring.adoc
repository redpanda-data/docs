...
- `serviceMonitorSelector.matchLabels.app.kubernetes.io/name`: The name of your Redpanda chart. The default is `redpanda`. The Redpanda Helm chart creates the ServiceMonitor resource with this label.
