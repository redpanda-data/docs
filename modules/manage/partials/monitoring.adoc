...
. Deploy Redpanda with monitoring enabled:
+
[tabs]
======
Helm + Operator::
...
[,bash]
----
kubectl get --namespace default prometheus prometheus --watch
----

. Deploy a NodePort Service for external access to Prometheus:
+
