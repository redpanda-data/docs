...
[NOTE]
====
The Schema Registry is built into Redpanda, and you can use it with the Schema Registry API or with the Redpanda UI. This section describes Schema Registry operations available in the Redpanda UI. 
====
