In {ui}, the **Schema Registry** tab lists registered and verified schemas, including their serialization format and versions. Select an individual schema to see which topics it applies to.
...
+
See also: xref:ROOT:reference:console/record-deserialization.adoc[].
...
* xref:ROOT:reference:console/record-deserialization.adoc[]
