...
To manage permissions at scale, assign a group to an xref:manage:security/authorization/rbac.adoc[RBAC] role. All users in the group inherit the role's ACLs automatically.
