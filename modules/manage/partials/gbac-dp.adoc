...
GBAC extends xref:manage:security/authentication.adoc#oidc[OIDC authentication] and supports two ways to grant permissions to groups: create xref:manage:security/authorization/acl.adoc[ACLs] with `Group:<name>` principals, or assign groups as members of xref:manage:security/authorization/rbac.adoc[RBAC] roles. Both approaches can be used independently or together.
