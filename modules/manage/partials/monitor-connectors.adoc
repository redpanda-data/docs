...
Redpanda Support monitors managed connectors 24/7 to ensure they meet service level agreements (SLAs). If an incident occurs, Redpanda Support follows an incident response process to quickly mitigate it.
