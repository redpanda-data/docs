...
. Run `rpk cluster config edit`, and then specify properties specific to your object storage provider (your cluster will like require a restart after any changes to these properties):
+
|===
