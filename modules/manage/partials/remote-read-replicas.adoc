...
:tiered-storage-link: manage:kubernetes/tiered-storage/k-tiered-storage.adoc
:data-archiving-link: manage:kubernetes/tiered-storage/k-tiered-storage.adoc#data-archiving
endif::[]
