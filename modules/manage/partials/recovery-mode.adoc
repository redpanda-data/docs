...
The following examples show you how to use the Admin API to enable or disable partitions. The examples assume that the Admin API port is `8081`.

ifdef::env-kubernetes[For help connecting to the Admin API, see xref:manage:kubernetes/networking/connect-to-redpanda.adoc[]]
...
--
```bash
curl -X POST -d '{"disabled": true}' http://localhost:8081/cluster/partitions/<partition-namespace>/<topic-name>/<partition-id>
```
--
====
...
--
```bash
curl -X POST -d '{"disabled": false}' http://localhost:8081/cluster/partitions/<partition-namespace>/<topic-name>/<partition-id>
```
--
====
...
--
```bash
curl -X POST -d '{"disabled": true}' http://localhost:8081/cluster/partitions/<partition-namespace>/<topic-name>
```
--
====
...
--
```bash
curl -X POST -d '{"disabled": false}' http://localhost:8081/cluster/partitions/<partition-namespace>/<topic-name>
```
--
====
...
--
```bash
curl http://localhost:8081/cluster/partitions/<partition-namespace>/<topic-name>?disabled=true
```
--
====
