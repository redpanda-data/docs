...
|Verify identity of current user
|✅
|✅

|Reload keys from identity provider
|❌
|✅

|Reload keys and disconnect clients
|❌
|✅
...
|Get Raft recovery status
|✅
|✅

|Get transaction manager migration status
|✅
|✅
