...
- If your OIDC token's sub (subject) claim contains example@company.com, then:
* For superusers configuration: Use the exact sub claim value: example@company.com
* For ACL rules: Use the exact sub claim value: example@company.com
