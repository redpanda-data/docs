...
To enable SASL authentication for the Kafka API, set the xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] broker property of the Kafka listeners to `sasl`.

ifdef::env-kubernetes[The Redpanda Helm chart sets the xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] broker property to `sasl` for all Kafka listeners by default when you <<enable-authentication, enable authentication>>.]

ifndef::env-kubernetes[If you <<enable-sasl-authentication, enabled authentication with `enable_sasl=true`>>, Redpanda implicitly sets xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] to `sasl` for the Kafka listeners.]
...
----
+
For HTTP Proxy (required when xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`]: `none` starting in Redpanda 25.2):
+
[,yaml]
----
pandaproxy_client:
...
----
+
When HTTP Proxy API listeners use xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`]: `none`, the HTTP Proxy client uses these credentials to authenticate with the Kafka API. The user specified in `scram_username` must have appropriate permissions to access the required Kafka resources.
+
...
To enable SASL/PLAIN authentication for the Kafka API, set the xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] broker property of the Kafka listeners to `sasl`.
...
To enable mTLS authentication, set xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] broker property for a listener to `mtls_identity`. For example, to enable mTLS authentication for the internal Kafka API listener, in `redpanda.yaml`, enter:
...
To enable basic authentication for specific listeners, set xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] broker property to `http_basic`. For example, in `redpanda.yaml`, enter:
...
To enable OIDC for specific listeners, set xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] broker property to `http_basic`. For example, in `redpanda.yaml`, enter:
...
To disable authentication for a listener, set xref:reference:properties/broker-properties.adoc#authentication_method[`authentication_method`] broker property to `none`:
