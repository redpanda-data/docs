...
. Use the xref:reference:rpk/rpk-acl/rpk-acl-create.adoc[`rpk acl create`] command to grant xref:security/authorization/index.adoc[`create` and `describe` permissions] to `myuser` in the cluster:
+
```bash
