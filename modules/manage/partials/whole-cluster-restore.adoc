...
TIP: If you need to restore only a subset of topic data, consider using xref:deploy:redpanda/manual/resilience/disaster-recovery/topic-recovery.adoc[topic recovery] instead of a Whole Cluster Restore.
