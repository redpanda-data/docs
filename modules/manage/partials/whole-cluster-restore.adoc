...
By default, Redpanda uploads cluster metadata to object storage periodically. You can manage metadata uploads, or disable them entirely, with the following cluster configuration properties:
