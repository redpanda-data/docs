...
- Set the `cloud_storage_enable_remote_allow_gaps` cluster configuration property to `true`, which allows for gaps in the logs of all Tiered Storage topics in the cluster.
