...
CAUTION: Redpanda strongly recommends that you avoid toggling Tiered Storage on and off, because this can result in inconsistent data and data gaps in Tiered Storage for a topic.
