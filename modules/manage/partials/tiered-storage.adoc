...
CAUTION: Redpanda strongly recommends that you do not re-enable Tiered Storage after previously enabling and disabling it, because this can result in inconsistent data and data gaps in Tiered Storage for a topic.
...
Redpanda strongly recommends that you do not re-enable Tiered Storage after previously enabling and disabling it, because this can result in inconsistent data and data gaps in Tiered Storage for a topic.
====
...
After topic configuration, if Tiered Storage was disabled and must be enabled, or was enabled and must be disabled, Redpanda uses the local retention properties set for the topic. It is strongly recommended that you do not re-enable Tiered Storage after previously enabling and disabling it, because this can result in inconsistent data and data gaps in Tiered Storage for a topic.
