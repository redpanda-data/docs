...
Use the ListKafkaConnections service in Admin API v2 to identify which client connections are driving the majority of, or the change in, the produce or consume throughput.
