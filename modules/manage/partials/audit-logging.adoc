...
[cols="1,3"]
|===
|Data Logging Level |Audit event
...
* Successful and failed attempts to add/remove users from the system
...
* Type of transaction
* Transaction data
* Transaction result (success/fail) and reason of failure
* Transaction number
* Failed attempts to access system data
* Failed attempts to access critical directories and files
* Use of external/peripheral devices
...
|Network Level
a|* Source IP address (IPv4 or IPv6)
