...
*Redpanda Console*: To view audit events in Redpanda Console, set `console.auditLog.enabled: true` in the Console configuration. See xref:console:config/configure-console.adoc[].
