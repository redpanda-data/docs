...
|User group memberships |Yes |`user.groups` field with type `idp_group`. Included in authentication events for OIDC users. See xref:manage:security/authorization/gbac.adoc[].
