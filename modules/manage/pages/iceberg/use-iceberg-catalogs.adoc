...
* config_ref:iceberg_rest_catalog_crl,true,properties/cluster-properties[`iceberg_rest_catalog_crl`]: The contents of a certificate revocation list for prop:iceberg_rest_catalog_trust[].
ifndef::env-cloud[]
