...
/*
After setting these configurations, you can optionally trigger compaction and 
liquid clustering on an existing table. Run OPTIMIZE to see any immediate 
effects of predictive optimization on the table.
*/
