...
If you produce the following record to a topic named `ClickEvent` topic, and do not use the Schema Registry wire format that includes the magic byte and schema ID:
