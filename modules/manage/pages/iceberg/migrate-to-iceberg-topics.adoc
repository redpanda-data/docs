...
* For migrating multi-table fan-out patterns, xref:develop:data-transforms/how-transforms-work.adoc[data transforms] enabled on your cluster.
...
* Incorrect routing logic or routing field missing from input messages.
* When using Schema Registry validation: schema registration failed during initialization, preventing the transform from starting. 
