...
. Use xref:develop:data-transforms/how-transforms-work.adoc[data transforms] to route records based on the routing field.
...
* Schema Registry issues. For example, Redpanda cannot find the embedded schema ID in Schema Registry.
