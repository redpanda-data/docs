...
- Delete the Redpanda topic associated with the Iceberg table. This is the default behavior set by the config_ref:iceberg_delete,true,properties/cluster-properties[`iceberg_delete`] cluster property and the prop:redpanda.iceberg.delete[] topic property. If you set this property to `false`, the Iceberg table remains even after you delete the topic.
