...
[IMPORTANT]
====
Redpanda v25.3 introduces breaking schema changes for Iceberg topics. Before upgrading, review xref:manage:iceberg/breaking-schema-changes.adoc[] and follow the required migration steps to avoid data loss or query errors.
====
