= Recovery Mode
:description: Use recovery mode to start Redpanda in "metadata only" mode and disable partitions
...
You may find that problems preventing normal cluster startup are isolated to certain partitions or topics. You can use rpk or the Admin API to disable these partitions even outside of recovery mode. You can disable partitions at the topic level, or individual partition level. 
