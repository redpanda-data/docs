...
In flag form to set up a general producing/consuming client, you can invoke xref:reference:rpk/rpk-acl-create.adoc[`rpk acl create`] up to three times with the following (including your `--allow-principal`):
