...
5. Define the permissions (ACLs) for the role. You may create ACLs for topics, consumer groups, and transactional IDs. You may also restrict your new role to a specific cluster.
...
6. You may add or remove existing (ACLs) for the role. As when creating a new role, you can create or modify ACLs for topics, consumer groups, and transactional IDs. You may also restrict your role to a specific cluster.
