...
ifdef::env-cloud[]
For complex organizational hierarchies or large numbers of users, consider using xref:security:authorization/rbac/rbac_dp.adoc[] for a more flexible and efficient way to manage user permissions. 
