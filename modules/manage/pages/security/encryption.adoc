...
TIP: Redpanda provides several public Prometheus metrics to help operators manage TLS certificate expiration and avoid surprise outages. Refer to the xref:reference:public-metrics-reference.adoc#tls_metrics[public metrics reference] for a full list of available TLS metrics.
