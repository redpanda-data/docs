...
See the link:/api/doc/admin/v2[Admin API v2 reference] for the current list of available v2 endpoints. Otherwise, see the link:/api/doc/admin/v2[Admin API v1 reference] for a full list of supported v1 endpoints.
...
To use the Admin API v1 to [decommission a broker], send a PUT request to the link:/api/doc/admin/operation/operation-decommission[`/v1/brokers/\{broker_id}/decommission`] endpoint:
