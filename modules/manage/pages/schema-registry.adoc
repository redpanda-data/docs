...
[NOTE]
====
This section describes using the Schema Registry API, but if you're using Redpanda Console (or Redpanda Cloud), you can also xref:manage:console/schema-registry.adoc[manage Schema Registry operations in Redpanda Console].
====
