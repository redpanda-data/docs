...
You may sometimes want to reset a configuration value back to its default. The method to do this depends on how you're managing your Redpanda deployment.
...
If you're using the Redpanda Operator and want to reset a configuration property back to its default, follow these steps:
