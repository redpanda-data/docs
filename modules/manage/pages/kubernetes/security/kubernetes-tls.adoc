...
----
NAME                                 READY
redpanda-default-cert                True <1>
redpanda-default-root-certificate    True <2>
redpanda-external-cert               True <3>
redpanda-external-root-certificate   True <4>
----

<1> Self-signed certificate for internal communications.
<2> Root certificate authority for the internal certificate.
<3> Self-signed certificate for external communications.
<4> Root certificate authority for the external certificate.
...
Make sure to add the `-X tls.enabled=true` option:
