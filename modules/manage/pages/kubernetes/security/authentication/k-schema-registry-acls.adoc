...
* *Schema Registry Authorization enabled*: Schema Registry Authorization must be enabled on the Redpanda cluster. See xref:manage:schema-reg/schema-reg-authorization.adoc#enable-schema-registry-authorization[Enable Schema Registry Authorization].
