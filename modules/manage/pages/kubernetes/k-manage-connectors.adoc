...
When you have Kafka Connect deployed, you can create and manage connectors using Redpanda Console or the Kafka Connect REST API. To build streaming data pipelines with enterprise support and without Kafka Connect infrastructure, consider running xref:manage:kubernetes/k-connect-pipelines.adoc[Redpanda Connect pipelines] badge::[label=beta] with the Redpanda Operator instead.

include::shared:partial$community-supported-connectors.adoc[]

== Prerequisites

- xref:deploy:redpanda/kubernetes/k-production-deployment.adoc[Deploy a Redpanda cluster with Redpanda Console].
- xref:deploy:kafka-connect/k-deploy-kafka-connect.adoc[Deploy Kafka Connect].
- Ensure Redpanda Console is configured to connect to Kafka Connect (see the xref:deploy:kafka-connect/k-deploy-kafka-connect.adoc#configure-redpanda-console-to-connect-to-kafka-connect[Redpanda Console configuration] in the deployment guide).
...
. Verify the Redpanda Console configuration includes Kafka Connect settings (see xref:deploy:kafka-connect/k-deploy-kafka-connect.adoc#troubleshooting-console-connectivity[deployment guide troubleshooting])
...
----
+
For more detailed logging configuration, see xref:deploy:kafka-connect/k-deploy-kafka-connect.adoc#logging[logging configuration] in the deployment guide.
...
- xref:deploy:kafka-connect/k-deploy-kafka-connect.adoc#install-a-new-connector[Install additional connector plugins]
