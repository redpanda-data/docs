...
TIP: To build streaming data pipelines with enterprise support and no Kafka Connect infrastructure, run Redpanda Connect pipelines declaratively with the Redpanda Operator. See xref:manage:kubernetes/k-connect-pipelines.adoc[].
