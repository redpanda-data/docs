...
To enable rack awareness in your Redpanda cluster, configure cluster with the key you used to annotate or label Node resources with the availability zone.
