...
For all available endpoints, see link:/api/doc/http-proxy/[].
...
For all available endpoints, see link:/api/doc/schema-registry/[].
--
======
...
For all available endpoints, see link:/api/doc/admin/[].
