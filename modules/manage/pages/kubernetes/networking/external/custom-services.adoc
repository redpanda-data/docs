...
Make sure that your custom Service listens on the advertised ports that are configured for each listener. See xref:./configure-listeners[].

== Next steps

- xref:./configure-listeners[]
