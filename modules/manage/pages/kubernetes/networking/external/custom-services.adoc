...
Make sure that your custom Service listens on the advertised ports that are configured for each listener. See xref:manage:kubernetes/networking/configure-listeners.adoc[].
