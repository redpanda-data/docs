...
. Delete the StatefulSet associated with your Redpanda brokers using the `cascade=orphan` option. This action will delete the StatefulSet while leaving the Pods and their associated PVCs intact.
+
```bash
