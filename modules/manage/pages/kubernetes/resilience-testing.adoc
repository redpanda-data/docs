...
It's best practice to automate failure scenarios as part of your regular testing to identify any weaknesses in your deployment.
You can use tools, such as https://netflix.github.io/chaosmonkey/[Chaos Monkey] and https://docs.litmuschaos.io/docs/getting-started/installation/[LitmusChaos].
