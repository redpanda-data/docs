...
TIP: To get more detailed information about your Redpanda deployment, generate a xref:troubleshooting/diagnostics-bundle.adoc[diagnostics bundle], which includes the Redpanda configuration files for all brokers in the cluster.
