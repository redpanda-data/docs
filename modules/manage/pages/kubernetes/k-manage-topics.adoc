...
In addition to the general prerequisites for managing topics, ensure that:

- Iceberg support is enabled in your Redpanda cluster.
- Tiered Storage is enabled in your Redpanda cluster.

For more details about enabling Iceberg support on your Redpanda cluster, see xref:manage:topic-iceberg-integration.adoc[].
