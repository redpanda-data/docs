...
Starting from version 24.3, decreasing the number of CPU cores in a production cluster is supported. xref:24.3@streaming:upgrade:index.adoc[Upgrade to version 24.3] or later to access this feature.
