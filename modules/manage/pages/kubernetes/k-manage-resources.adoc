...
- Ensure that the number of CPU cores you allocate to Redpanda is an even integer. This configuration allows Redpanda to leverage the static CPU manager policy, granting the Pod exclusive access to the requested cores for optimal performance.
...
Set CPU cores to an even integer to leverage static CPU manager policy, granting the Pod exclusive access to the requested cores for optimal performance.
|===
