...
include::manage:partial$troubleshooting.adoc[tags=deployment]
//end::deployment[]


//tag::tls[]
include::manage:partial$troubleshooting.adoc[tags=tls]
...
//tag::sasl[]
include::manage:partial$troubleshooting.adoc[tags=sasl]
