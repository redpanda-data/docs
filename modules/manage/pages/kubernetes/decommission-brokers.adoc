...
Cost and use case requirements will dictate how much to spend on local disk capacity. Tiered Storage can help to both decrease costs and expand data retention capabilities. For details, see xref:manage:kubernetes/storage/tiered-storage.adoc[Tiered Storage].
