...
* *Redpanda cluster*: Ensure you have at least version v2.3.0-24.2.10 of the xref:deploy:deployment-option/self-hosted/kubernetes/k-production-deployment.adoc[Redpanda Operator] and a Redpanda resource deployed and accessible.
