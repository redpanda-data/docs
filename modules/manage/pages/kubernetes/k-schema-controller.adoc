...
* *Redpanda cluster*: Ensure you have at least version v2.3.0-24.3.1 of the xref:deploy:redpanda/kubernetes/k-production-deployment.adoc[Redpanda Operator] and a Redpanda resource deployed and accessible.
