...
[NOTE]
====
Redpanda supports uneven rack placements. For example, you may have four or five brokers to assign across three racks. 

An uneven placement might cause undesirable effects:
...
An even ratio of brokers to racks helps to avoid these scenarios and is therefore considered optimal.
====
