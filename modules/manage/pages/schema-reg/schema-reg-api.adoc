...
If the request is successful, the rpk output returns the subject and version, and the HTTP response returns the schema:
...
If the request is successful, it returns the subject, and for HTTP requests, its associated schema:
