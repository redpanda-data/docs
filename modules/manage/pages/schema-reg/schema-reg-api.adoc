...
This creates two ACLs: one for registry-level read operations (like listing schema types) and another for subject-level read operations (like retrieving schemas).
