...
ifdef::env-cloud[]
. You need a running Redpanda cluster. If you don't have one, you can xref:redpanda-cloud:get-started:cluster-types:serverless.adoc[create a cluster] using Redpanda Serverless.
endif::[]
+
