...
----
+
You can also use xref:get-started:intro-to-rpk.adoc[`rpk`] to interact with the Schema Registry. The `rpk registry` set of commands call the different API endpoints as shown in the curl and Python examples. 
