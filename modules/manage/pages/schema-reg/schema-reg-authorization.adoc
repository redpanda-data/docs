...
When migrating schemas between clusters, the destination user needs:

[,bash]
----
# For reading schemas from source and writing to target
rpk security acl create \
  --allow-principal migrator-user \
  --operation read,write,describe,alter_configs,describe_configs \
  --registry-global
----
