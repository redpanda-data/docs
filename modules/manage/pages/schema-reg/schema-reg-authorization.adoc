...
6. **Enable ACL authorization** - Enable prop:kafka_enable_authorization[] and prop:schema_registry_enable_authorization[]
...
* prop:schema_registry_enable_authorization[] is set to `true`.
