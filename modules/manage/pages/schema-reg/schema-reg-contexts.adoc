...
[IMPORTANT]
====
`schema_registry_enable_qualified_subjects` is _not_ a dynamic property. After changing it, you must restart your brokers for the change to take effect. If qualified subjects are still being treated as literal names after enabling the flag, a broker restart is the most likely cause.
====
+
ifndef::env-cloud[]
[NOTE]
