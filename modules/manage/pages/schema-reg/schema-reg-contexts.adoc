...
Following are the various configuration options available for Schema Registry contexts.
...
----
{
  ...
  "references": [
    {
      "name": "CommonType",
      "subject": "CommonType", // assumes CommonType is a subject is in the same context as the root schema
      "version": 1
    }
  ]
}
