...
* For information about using the API, see xref:manage:schema-reg/schema-reg-api.adoc[].
* For general information, see xref:manage:schema-reg/schema-reg-overview.adoc[].
====
