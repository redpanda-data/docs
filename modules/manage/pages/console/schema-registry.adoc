...
[NOTE]
====
This section describes managing Schema Registry operations in Redpanda Console. You can also xref:manage:schema-registry.adoc[manage Schema Registry operations with the API].
====
