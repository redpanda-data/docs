= Topic Documentation
:description: Embed your topic's documentation into Redpanda Console by providing access to a GitHub repository that hosts your documentation files in Markdown.
