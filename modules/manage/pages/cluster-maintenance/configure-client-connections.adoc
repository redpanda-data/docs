...
* For Redpanda version 25.3 and later, use the Admin API v2 ListKafkaConnections endpoint to identify:
+
-- 
...
See also: link:/api/doc/admin/operation/operation-redpanda-core-admin-v2-brokerservice-listkafkaconnections[ListKafkaConnections reference], xref:manage:monitoring.adoc#throughput[Monitor Redpanda]
====
endif::[]
