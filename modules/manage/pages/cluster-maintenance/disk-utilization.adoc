...
* A combination of age and aggregate size, triggering when either is exceeded.
...
Redpanda runs a log cleanup process in the background to apply these policy settings. If you start to run out of disk space, adjust your retention properties is an excellent way to reduce the amount of disk space used.
