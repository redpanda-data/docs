...
Redpanda runs a log cleanup process in the background to apply these policy settings. If you start to run out of disk space, adjusting your retention properties, along with enabling dynamic space management, is an excellent way to reduce the amount of disk space used.
