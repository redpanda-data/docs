...
ifndef::env-cloud[]
Use the `rpk cluster connections` command to monitor high-throughput producers:

[,bash]
----
rpk cluster connections list --node-id=1 --filter 'recentRequestStatistics.produceBytes > 1000000' --watch
----
