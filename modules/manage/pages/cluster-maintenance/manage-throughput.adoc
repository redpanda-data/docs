...
* `vectorized_kafka_quotas_client_quota_throughput` - Client quota throughput per rule and quota type
* `vectorized_kafka_quotas_client_quota_throttle_time` - Client quota throttling delay, in seconds, per rule and quota type
