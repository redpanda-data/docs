...
TIP: You may find it helpful to monitor to check the xref:{monitor-doc}[current produce rate] of client connections before you configure throughput quotas.
