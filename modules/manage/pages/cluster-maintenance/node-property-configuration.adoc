...
:description: pass:q[Node configuration properties using `redpanda.yaml` file.]
:page-aliases: cluster-administration:node-property-configuration.adoc, deploy:deployment-option/self-hosted/manual/production/node-property-configuration.adoc
