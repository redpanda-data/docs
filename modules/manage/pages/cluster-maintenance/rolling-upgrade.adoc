...
:page-aliases: install-upgrade:rolling-upgrade.adoc, install-upgrade:version-upgrade.adoc, platform:cluster-management/version-upgrade.adoc, platform:cluster-administration/version-upgrade.adoc, platform:reference/version-upgrade.adoc
