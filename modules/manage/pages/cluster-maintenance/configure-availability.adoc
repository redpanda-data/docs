...
. Set the `kafka_connections_max_per_ip` value based on your analysis. Use the upper bound of normal connections from step 3, or use a lower value if you know how many connections per client are being opened.
...
* This limit does not apply to HTTP Proxy connections.
