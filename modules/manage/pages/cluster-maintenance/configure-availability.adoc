...
. Analyze the connection data to identify the normal range of connections for each broker during typical traffic cycles. For example, in the following screenshot, the normal pattern per broker is around 200-300 connections:
+
