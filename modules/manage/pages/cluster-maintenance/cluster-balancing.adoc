...
| `random`
| Accepts the first random move that improves balance. Less efficient than `calibrated` because it doesn't prioritize high-impact moves. Kept for legacy compatibility.
