...
Partition balancing is invoked every 30 seconds by default. Redpanda also provides partition replica balancing when brokers are added or decommissioned.
