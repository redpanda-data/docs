...
[NOTE]
====
The Schema Registry is built into Redpanda, and you can use it with the API or the Redpanda Console UI. This section describes Schema Registry operations in the API. 

* For information about using the UI, see xref:manage:schema-registry/schema-reg-ui.adoc[]. 
