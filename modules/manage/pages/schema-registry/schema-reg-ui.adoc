...
[NOTE]
====
The Schema Registry is built into Redpanda, and you can use it with the API or the Redpanda Console UI. This section describes Schema Registry operations in the UI. 

* For information about using the API, see xref:manage:schema-registry/schema-reg-api.adoc[].
* For general information, see xref:manage:console/schema-registry.adoc[]
====
...
. To register a schema, click **Create new schema**. 
+
...
* xref:manage:console/protobuf.adoc#schema-registry[]
