...
A profile saves rpk-specific command properties. For details, see xref:manage/rpk/intro-to-rpk#specifying-command-properties[Specifying command properties].
