...
:description: Upgrade clusters in a Shadowing topology safely: upgrade the shadow cluster before the source cluster, and use deferred finalization for bidirectional topologies.
...
* Both clusters need a valid Enterprise Edition license. Setting prop:features_auto_finalization[] to `false` is rejected without one.
