...
* Both clusters must be running at least version 26.1.9 or 25.3.15, and the upgrade target must be 26.2 or later. See xref:upgrade:deferred-finalization.adoc#prerequisites[Defer Upgrade Finalization: Prerequisites].
