...
NOTE: If you're running Redpanda in Kubernetes, see xref:manage:kubernetes/shadowing/k-monitor-shadowing.adoc[] for Kubernetes-specific monitoring procedures.
