...
The following sample configuration file creates a shadow link that shadows all source topics and replicates schemas from a Confluent Schema Registry. The sections that follow explain each schema replication setting.
