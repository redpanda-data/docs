...
// SME review feedback from @pgellert applied 2026-07-16 (PR #1776). One DRAFT-VERIFY item
// remains (sync defaults); re-check it against a running 26.2 build before publishing.
