...
The Iceberg data is available to query in Clickhouse. The table structure is derived from the schema, and in this case, the `test-topic` table contains columns based on the  values:
