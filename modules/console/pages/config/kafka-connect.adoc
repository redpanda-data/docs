...
You must xref:deploy:deployment-option/docker-image.adoc[deploy a Kafka Connect cluster separately] before configuring Redpanda Console to connect to it.
