...
- `urls`: Provide the URLs to your Schema Registry endpoints. Multiple URLs can be specified for redundancy. To set up the Schema Registry in {ui} with Redpanda Streaming, see xref:console:ui/schema-reg.adoc[].
