...
Configure the connection to the Redpanda Admin API to enable additional Redpanda-specific features in Redpanda Console, such as viewing the Redpanda version, viewing cluster metrics, and managing partitions.
