...
TIP: This option is best for deployments that are not connected to a Redpanda cluster. If you plan to connect Redpanda Console to a Redpanda cluster, consider uploading the license to the Redpanda cluster. See xref:get-started:licensing/add-license-redpanda/index.adoc[].
