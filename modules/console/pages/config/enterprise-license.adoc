...
+
--
When using the standalone Redpanda Console Helm chart, set the license file path in your Helm values:
...
console:
  extraEnv:
    - name: REDPANDA_LICENSE_FILEPATH
      value: <path-to-license-file>
```
...
+
--
When using the standalone Redpanda Console Helm chart, set the license contents in your Helm values:
