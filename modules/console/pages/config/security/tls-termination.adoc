...
If you host Redpanda Console under a sub-path of your domain, such as `+https://my-company.com/redpanda/console+`, configure xref:console:config/http-path-rewrites.adoc[HTTP path rewrites] in Redpanda Console.
