...
authentication:
  ...
  basic:
    enabled: true <3>
----
<1> `authentication.jwtSigningSecret` (required): The secret key used to sign JSON Web Tokens (JWTs). This key must be kept confidential to ensure the integrity and security of user sessions.
