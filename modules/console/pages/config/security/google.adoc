= Google SSO Setup
:description: Integrate Redpanda Console with Google to allow your users to use their Google identities to sign in to Console.
:page-aliases: console:single-sign-on/identity-providers/google.adoc, manage:security/console/google.adoc
...
and their memberships using the Google Workspace API. Follow this https://developers.google.com/admin-sdk/directory/v1/guides/delegation[Google guide^]
