...
:page-categories: Redpanda Console, Data Observability
// ========================AUTOMATED TESTS===================================
...
// (step {"action":"find", "selector": "#menu-button-\\:r97\\:", "matchText": "Add filter", "click": true, "timeout": 10000})
// (step {"action":"find", "selector": "div.chakra-menu__menu-list button:last-of-type", "matchText": "Javascript Filter", "click": true, "timeout": 10000})
. Give your filter a name such as 'Find .edu domains'.
// (step {"action":"find", "selector": "#field-\\:rcn\\:", "typeKeys": "Find .edu domains", "click": true, "timeout": 10000})
. Replace the default JavaScript code with the following:
// (step {"action":"find", "selector": "textarea.inputarea", "typeKeys": "return value.email.includes('.edu');//", "click": true})
+
[,js]
----
...
// (step {"action":"find", "selector": "footer.chakra-modal__footer button:last-of-type", "matchText": "Save", "click": true})
+
...
In the *Schema Registry* menu item, you can see an overview of your schemas as well as create, manage, and inspect your schemas without leaving Redpanda Console.
...
In the *Consumer Groups* menu item, you can see detailed insights into consumer groups, including their configuration and status. You can:
...
In the *Security* menu item, you can:
...
For details about authentication in Redpanda, see xref:manage:security/authentication.adoc[].
...
In the *Connectors* menu item, you can manage your Kafka Connect clusters or view instructions for deploying Redpanda Connect.

See also:

- xref:console:config/kafka-connect.adoc[]
- xref:redpanda-connect:ROOT:about.adoc[]
- xref:deploy:deployment-option/self-hosted/docker-image.adoc[]
