...
+
This Docker Compose file deploys a Redpanda Streaming cluster, Redpanda Console, and Redpanda Connect. Redpanda Connect is used to generate demo data and produce it to a topic on the Redpanda cluster.
+
