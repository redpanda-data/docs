...
. Try to access the `logins` topic:
+
[,bash]
----
...
. Access the `transactions` topic that Sasha has permissions for.
+
[,bash]
----
...
In the *Connectors* menu item, you can manage your Kafka Connect clusters or view instructions for deploying Redpanda Connect connectors.
