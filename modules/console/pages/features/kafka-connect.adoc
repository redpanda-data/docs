= Kafka Connect
:description: Connecting one or more Kafka connect clusters with your Redpanda Console deployment.
...
You can view all available configuration options in the xref:console:reference/config.adoc[reference config].
