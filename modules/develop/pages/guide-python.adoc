...
[,py]
----
include::develop:example$python/docker/chat-room/admin.py[]
----
...
[,py]
----
include::develop:example$python/docker/chat-room/producer.py[]
----
...
[,py]
----
include::develop:example$python/docker/chat-room/consumer.py[]
----
...
[,py]
----
include::develop:example$python/docker/chat-room/app.py[]
----
