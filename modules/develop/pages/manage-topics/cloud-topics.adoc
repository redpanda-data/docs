...
include::ROOT:develop:partial$cloud-topics-overview.adoc[tag=intro]

include::ROOT:develop:partial$cloud-topics-overview.adoc[tag=latency-explanation]
...
include::ROOT:develop:partial$cloud-topics-limitations.adoc[tag=limitations]
