...
- After a Cloud Topic is created, it cannot be converted back to a standard Redpanda topic. Conversely, existing topics created as standard topics cannot be converted to Cloud Topics.
