...
ifndef::env-cloud[]
NOTE: In Redpanda versions earlier than 26.2, you must also set the `cloud_topics_enabled` cluster property to `true` and restart the cluster. This property is deprecated in 26.2 and later. For details, see xref:upgrade:deprecated/index.adoc[Deprecated features].
endif::[]
