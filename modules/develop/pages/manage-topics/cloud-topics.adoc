...
include::streaming:develop:partial$cloud-topics-overview.adoc[tag=intro]

include::streaming:develop:partial$cloud-topics-overview.adoc[tag=latency-explanation]
...
include::streaming:develop:partial$cloud-topics-limitations.adoc[tag=limitations]
