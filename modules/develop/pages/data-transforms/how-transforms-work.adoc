...
- Transform functions have no external access to disk or network resources.
...
- When clients use the Kafka Transactions API on partitions of an input topic, transform functions process only committed records.
