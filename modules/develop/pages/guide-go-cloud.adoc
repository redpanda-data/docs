...
The client may not always know that the topic exists. You can verify that it exists and create it if not. In the `chat-room/` directory, create a source file called `admin.go` with the following content.
...
[,go]
----
include::develop:example$go/cloud/chat-room/admin.go[]
----
...
[,go]
----
include::develop:example$go/cloud/chat-room/producer.go[]
----
...
[,go]
----
include::develop:example$go/cloud/chat-room/consumer.go[]
----
...
[,go]
----
include::develop:example$go/cloud/chat-room/main.go[]
----
