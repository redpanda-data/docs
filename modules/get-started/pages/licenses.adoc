...
You can deploy Redpanda in a self-hosted environment (Redpanda platform) or as a fully-managed cloud service (Redpanda Cloud). To self-host Redpanda platform, select either the Community Edition or the Enterprise Edition:
