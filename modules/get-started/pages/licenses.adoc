...
You can deploy Redpanda in a self-hosted environment (Redpanda Enterprise) or as a fully-managed cloud service (Redpanda Cloud). To self-host Redpanda Enterprise, select either the Community Edition or the Enterprise Edition:
