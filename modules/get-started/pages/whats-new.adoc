...
* xref:cloud-docs:ROOT:get-started:whats-new-cloud.adoc[] 
* xref:cloud-docs:ROOT:get-started:cloud-overview.adoc#redpanda-cloud-vs-self-hosted-feature-compatibility[Redpanda Cloud vs self-hosted feature compatibility]
