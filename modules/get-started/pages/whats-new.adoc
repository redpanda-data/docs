...
* xref:reference:rpk/rpk-cluster/rpk-registry-mode.adoc[`rpk registry mode`]
* xref:reference:rpk/rpk-cluster/rpk-registry-mode-get.adoc[`rpk registry mode get`]
* xref:reference:rpk/rpk-cluster/rpk-registry-mode-reset.adoc[`rpk registry mode reset`]
* xref:reference:rpk/rpk-cluster/rpk-registry-mode-set.adoc[`rpk registry mode set`]
