...
Redpanda Console now supports a unified authentication and authorization system, including user impersonation, so you can authenticate to Redpanda using the same credentials you use to authenticate to Redpanda Console.
