...
== New topic recovery properties

The new properties xref:reference:cluster-properties.adoc[`cloud_storage_recovery_topic_validation_mode`] and xref:reference:cluster-properties.adoc[`cloud_storage_recovery_topic_validation_depth`] work together to add a consistency check that runs before a topic is recovered from object storage.
