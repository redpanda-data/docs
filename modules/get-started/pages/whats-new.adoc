...
The `rpk cluster storage recovery` command was renamed to xref:reference:rpk/rpk-cluster/rpk-cluster-storage-restore.adoc[`rpk cluster storage restore`]. You can still use `rpk cluster storage recovery` as an alias. 
