...
- As of v23.3.2, the `space_management_enable_override` and `retention_local_strict_override` properties, added as a workaround for prior versions of Redpanda, are no longer required. Redpanda now ignores these properties.
