...
- A new xref:reference:glossary.adoc[glossary] provides definitions helpful for working with Redpanda. In text, terms with hover text and a link to the glossary entry render with a dotted line; for example, glossterm:controller[].
