...
Redpanda Operator version v2.2.2-24.2.4 onwards supports the declarative management of users and access control lists (ACLs) using the new User resource. This feature allows you to:
