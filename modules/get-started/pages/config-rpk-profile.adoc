...
A profile saves rpk-specific command properties. For details, see xref:get-started/intro-to-rpk/#specifying-command-properties[Specifying command properties].
