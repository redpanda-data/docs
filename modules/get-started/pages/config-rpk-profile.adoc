...
A profile saves rpk-specific command properties. For details, see xref:get-started:intro-to-rpk.adoc#specifying-command-properties[Specify command properties].
