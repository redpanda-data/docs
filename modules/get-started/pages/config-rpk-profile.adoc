...
ifdef::env-cloud[]
A profile saves rpk-specific command properties. For details, see xref:manage:rpk/intro-to-rpk.adoc#specify-command-properties[Specify command properties].
