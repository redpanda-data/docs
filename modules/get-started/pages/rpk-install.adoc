...
You can also install `rpk` on your local machine as a xref:./rpk-install.adoc[standalone binary]. With this setup, you can connect to both a Redpanda cluster on your local machine, or an external one on a remote server.
