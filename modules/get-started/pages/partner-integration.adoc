...
To request a partner integration with Redpanda Data, reach out to (mailto:partners@redpanda.com)[partners@redpanda.com]. Provide a link to your product documentation or a blogpost explaining how your product integrates with Redpanda. After meeting these requirements, you can https://github.com/redpanda-data/docs/edit/main/modules/get-started/pages/partner-integration.adoc[contribute to this page^].
