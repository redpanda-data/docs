...
:description: Learn how to quickly install and run a Redpanda cluster.
...
TIP: The fastest and easiest way to start data streaming in the cloud is with a Serverless cluster free trial. Redpanda instantly prepares an account for you that includes a `welcome` cluster you can explore. You interact with Serverless clusters the same way you'd interact with Dedicated or BYOC clusters. To learn more, see xref:deploy:deployment-option/cloud/serverless.adoc[].

Follow these steps to spin up a Dedicated cluster with Redpanda Cloud, create a basic streaming application using the `rpk` command-line tool, and explore your cluster in glossterm:Redpanda Console[].
...
- xref:deploy:deployment-option/cloud/create-topic.adoc[]

include::shared:partial$suggested-reading.adoc[]

xref:rpk-install.adoc[Learn more about rpk] and explore the `rpk` commands that you used in this quickstart:
