...
Continuous Data Balancing is enabled by default for all new clusters, regardless of the license type. If your license expires and you apply a new license, this feature is re-enabled.
...
Continuous Intra-Broker Partition Balancing is enabled by default for all new clusters, regardless of the license type. If your license expires and you apply a new license, this feature is re-enabled.
