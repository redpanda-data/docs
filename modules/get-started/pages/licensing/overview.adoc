...
Continuous Data Balancing is enabled by default for all new clusters, regardless of the license type.
...
Continuous Intra-Broker Partition Balancing is enabled by default for all new clusters, regardless of the license type.
