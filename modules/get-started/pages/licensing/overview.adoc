...
In Redpanda Connect, you must download and apply a trial license to evaluate enterprise features. In this case, the 30 day evaluation period begins when you run your first data pipeline.
