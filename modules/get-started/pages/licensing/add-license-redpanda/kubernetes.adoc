...
If neither the Kubernetes Secret nor the license string is provided, Redpanda looks for the license at `/etc/redpanda/redpanda.license`.
...
----
+
NOTE: The new license automatically takes effect. You do not need to restart the Redpanda brokers. 
