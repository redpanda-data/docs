...
To enable xref:get-started:licensing/overview.adoc[enterprise features for Redpanda Streaming], you must have an Enterprise Edition license. This guide outlines how to apply or update an Enterprise Edition license for Redpanda Streaming in a Linux environment.
