...
* For information about a self-hosted Redpanda Enterprise deployment, see xref:./licenses.adoc[Redpanda Licensing].
* For information about a Redpanda Cloud deployment, see xref:redpanda-cloud:deploy:deployment-option/cloud/cloud-overview.adoc[Redpanda Cloud Overview].
