...
// (step {"runShell": {"command": "docker compose up -d --wait", "workingDirectory": "../docker-compose", "timeout": 50000, "exitCodes": [0]}})
// (step {"wait": 20000})
...
// (step {"checkLink": "http://localhost:8080", "statusCodes": 200})
...
// (step {"wait": 30000})
// (step {"screenshot": {"path": "../../modules/console/images/overview.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"wait": 15000})
// (step {"screenshot": {"path": "../../modules/console/images/broker-overview.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"screenshot": {"path": "../../modules/console/images/topic.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"screenshot": {"path": "../../modules/console/images/js-filter.png", "overwrite": "aboveVariation", "maxVariation": 0.3}})
+
...
// (step {"wait": 15000})
// (step {"screenshot": {"path": "../../modules/console/images/topic-documentation.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"wait": 5000})
// (step {"screenshot": {"path": "../../modules/console/images/schema-reg.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"find": {"selector": "[data-testid='password-input-toggle']", "click": true}})
// (step {"wait": 5000})
// (step {"screenshot": {"path": "../../modules/console/images/user.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
. Click *Create*.
...
// (step {"wait": 5000})
// (step {"screenshot": { "path": "../../modules/console/images/transforms.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"wait": 5000})
// (step {"screenshot": { "path": "../../modules/console/images/license.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"wait": 5000})
// (step {"screenshot": { "path": "../../modules/console/images/audit-logs.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
...
// (step {"goTo": "http://localhost:8080/overview"})
// (step {"wait": 5000})
// (step {"screenshot": { "path": "../../modules/console/images/degraded-cluster.png", "overwrite": "aboveVariation", "maxVariation": 0.1}})
