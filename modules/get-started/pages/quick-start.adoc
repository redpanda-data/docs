...
// (step {"find": {"selector": "[data-testid='password-input-toggle']", "click": true, "timeout": 15000}})
// (step {"find": {"selector": "[data-testid='test_field']", "click": true, "timeout": 15000}, "variables": {"password": "$$element.text"}})
// (step {"find": {"selector": "[data-testid='password-input-toggle']", "click": true, "timeout": 15000}})
