...
// (test start {"testId": "quickstart", "description": "Redpanda Streaming quickstart"})
...
- xref:get-started:licensing/overview.adoc[Learn more about enterprise features for Redpanda Streaming]
