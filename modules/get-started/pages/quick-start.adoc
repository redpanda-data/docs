...
This quickstart deployment comes with two pre-configured topics, `logins` and `transactions`, which are actively receiving data as part of a data pipeline deployed through Redpanda Connect. These topics simulate real-world data flows, enabling you to explore and interact with Redpanda Console features.
...
. On the Access control page, go to the *ACLs* tab.
