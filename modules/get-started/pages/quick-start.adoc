...
// (step {"find": {"selector": "input[data-testid='auth-password-input']", "timeout": 10000, "click": true, "type": "secretpassword"}})
// (step {"find": {"selector": "button[data-testid='auth-submit']", "elementText": "Log in", "timeout": 10000, "click": true}})
