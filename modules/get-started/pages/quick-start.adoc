...
// (step {"find": {"selector": "[data-testid='test_field']", "click": true}, "variables": {"password": "$$element.text", "timeout": 15000}})
// (step {"find": {"selector": "[data-testid='password-input-toggle']", "click": true, "timeout": 15000}})
// (step {"wait": 5000})
...
// (step {"wait": 5000})
// (step {"screenshot": {"path": "../../modules/console/images/license.png", "maxVariation": 0.10, "overwrite": "aboveVariation"}})
