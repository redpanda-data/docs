...
:page-aliases: quickstart:index.adoc, install-upgrade:index.adoc, install-upgrade:start-streaming.adoc, quickstart:console-installation, quickstart:quick-start-docker.adoc, quickstart:quick-start-linux.adoc, quickstart:quick-start-macos.adoc, quickstart:quick-start-windows.adoc, platform:getting-started/quick-start-docker.adoc, platform:getting-started/quick-start-linux.adoc, platform:getting-started/quick-start-macos.adoc, platform:getting-started/quick-start-windows.adoc
