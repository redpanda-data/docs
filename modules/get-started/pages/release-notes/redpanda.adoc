...
The following cluster properties were introduced in Redpanda v26.1.14 but are not included in v26.2.1. They were backported after the v26.2.1 tag was created, and they are available starting in v26.2.2:
