...
A new xref:manage:iceberg/rest-catalog/iceberg-topics-aws-glue.adoc[integration with AWS Glue Data Catalog] allows you to add Redpanda topics as Iceberg tables in your data lakehouse. The Glue catalog integration is available in Redpanda version 25.1.7 and later.

See xref:manage:iceberg/rest-catalog/index.adoc[] for available Iceberg REST catalog integrations.
