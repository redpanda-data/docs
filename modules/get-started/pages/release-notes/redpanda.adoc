...
* *`rpk redpanda admin` is deprecated*: Use xref:reference:rpk/rpk-cluster/rpk-cluster.adoc[`rpk cluster`] instead. The broker maintenance commands now live under `rpk cluster brokers`, and logger management lives under `rpk cluster loggers`.
