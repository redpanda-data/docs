...
The following cluster properties were introduced in Redpanda v26.1.14 but are not included in v26.2.1:

* `log_eviction_exempt_topics`
* `schema_registry_deferred_recovery`
* `schema_registry_replay_on_startup`

If you upgrade from v26.1.14 to v26.2.1, any values you set for these properties are not honored.
