...
You can now keep a feature-release upgrade open, soak testing the new version with a guaranteed rollback path, and finalize the upgrade when you are ready.

See xref:upgrade:deferred-finalization.adoc[Defer Upgrade Finalization].
