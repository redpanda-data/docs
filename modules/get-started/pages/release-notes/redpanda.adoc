...
Redpanda now supports the DescribeUserSCRAMCredentialsRequest and AlterUserSCRAMCredentialsRequest APIs as described in https://cwiki.apache.org/confluence/display/KAFKA/KIP-554%3A+Add+Broker-side+SCRAM+Config+API[KIP-554]. This allows you to manage SASL user credentials using Kafka API. 

See also: xref:manage:security/authentication.adoc#sasl[Configure Authentication]
