...
The Redpanda Helm chart now deploys **Redpanda Console v3** by default. Console v3 introduces support for unified authentication and authorization with Redpanda, including user impersonation.
