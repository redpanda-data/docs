...
https://github.com/redpanda-data/redpanda-operator/releases/tag/v2.3.4-24.3.2[View the release notes^].

=== Sidecar for broker decommissioning and PVC cleanup

Redpanda Operator v2.3.7-24.3.6 and v5.9.21 of the Redpanda Helm chart introduce two new sidecar-based controllers to manage broker decommissioning and persistent volume cleanup:
