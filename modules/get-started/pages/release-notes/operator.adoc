...
Outdated and deprecated fields have been removed from the CRD, resulting in a cleaner and more maintainable configuration. Before upgrading, review and update your current configurations to remove any deprecated fields.
