...
The NodeWatcher and Decommission controllers are deprecated and replaced by these sidecars. To enable the new sidecars, set the `enabled` flag to `true` in your Redpanda custom resource. For example:
