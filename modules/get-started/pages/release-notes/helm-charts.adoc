...
Outdated and deprecated fields have been removed from the Helm chart values, resulting in a cleaner and more maintainable configuration. If upgrading, review and update your current configurations to remove any deprecated fields.
