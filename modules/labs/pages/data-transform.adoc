...
To enable the coprocessor that runs the data transformation, set the xref:cluster-administration:cluster-property-configuration.adoc[cluster properties] and enable the engine in the `redpanda.yaml` configuration file.
