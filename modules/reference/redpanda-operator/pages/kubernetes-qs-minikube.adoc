= Install Redpanda for Kubernetes with minikube
...
Do not use mnikube for production workloads. Instead, xref::kubernetes-qs-cloud.adoc[Install Redpanda for Kubernetes on Cloud].
:::
