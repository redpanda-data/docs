...
Redpanda Cloud shared responsibility model clarify the expectations around cloud resource ownership between Redpanda and Customer with respect to infrastructure, security and Redpanda service.
