...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-enterprise"]
=== Enterprise 
...
| Field | Description
| *`license`* __string__ | 
| *`licenseSecretRef`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-enterpriselicensesecretref[$$EnterpriseLicenseSecretRef$$]__ | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-enterpriselicensesecretref"]
...
.Appears in:
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-enterprise[$$Enterprise$$]
...
| *`domain`* __string__ | 
| *`enabled`* __boolean__ | 
| *`service`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-externalservice[$$ExternalService$$]__ | 
| *`sourceRanges`* __string array__ | 
| *`type`* __string__ | 
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-externalservice"]
=== ExternalService 
...
| *`license_key`* __string__ | Deprecated: Use `Enterprise.LicenseKey` instead.
| *`license_secret_ref`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-licensesecretref[$$LicenseSecretRef$$]__ | Deprecated: Use `Enterprise.LicenseSecretRef` instead.
| *`enterprise`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-enterprise[$$Enterprise$$]__ | 
...
| *`nameOverride`* __string__ | 
| *`fullnameOverride`* __string__ | 
| *`priorityClassName`* __string__ | 
| *`image`* __RawExtension__ | 
| *`imagePullSecrets`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`serviceAccount`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`annotations`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`podAnnotations`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`podLabels`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`podSecurityContext`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`securityContext`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`service`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`ingress`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`resources`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`autoscaling`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`nodeSelector`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`tolerations`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`affinity`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`topologySpreadConstraints`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`extraEnv`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`extraEnvFrom`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`extraVolumes`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`extraVolumeMounts`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`extraContainers`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`initContainers`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
| *`secretMounts`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
...
| *`console`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-runtime-rawextension[$$RawExtension$$]__ | 
|===
...
| *`tiered`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-tiered[$$Tiered$$]__ | 
|===
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-tiered"]
=== Tiered 
...
|===
| Field | Description
| *`mountType`* __string__ | 
| *`hostPath`* __string__ | 
| *`persistentVolume`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-tieredstoragepersistentvolume[$$TieredStoragePersistentVolume$$]__ | 
| *`config`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-tieredconfig[$$TieredConfig$$]__ | 
|===
...
.Appears in:
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-src-go-k8s-apis-redpanda-v1alpha1-tiered[$$Tiered$$]

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`cloud_storage_enabled`* __string__ | 
