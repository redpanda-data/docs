= Internal Metrics
:description: pass:q[This page describes the original metrics available on `:9644/metrics`. These are provided for internal support, troubleshooting, and backward compatibility.]
