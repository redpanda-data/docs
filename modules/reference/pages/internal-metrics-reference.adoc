...
Shows the true utilization of the CPU by a Redpanda process. Check this metric on a per-shard basis. If a shard is at 100% utilization for a continuous period of time, it likely results in high latency.
