...
:description: pass:q[Reference of Redpanda internal metrics exported from the `/metrics` Prometheus endpoint. Use internal metrics during development for detailed analysis, debugging, and troubleshooting.]
