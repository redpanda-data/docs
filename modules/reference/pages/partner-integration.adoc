...
| https://peerdb.io/[PeerDB^] |If Postgres is at the core of your business as a major source of data, PeerDB provides a fast, simple and cost-effective way to replicate data from Postgres to Data Warehouses, Queues and Storage. | https://docs.peerdb.io/connect/kafka[Quickstart guide]
