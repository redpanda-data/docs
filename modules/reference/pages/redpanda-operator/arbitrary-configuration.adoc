...
:page-aliases: platform:deploy-self-hosted/arbitrary-configuration.adoc, platform:deployment/arbitrary-configuration, platform:features/kubernetes-additional-config.adoc, deployment:arbitrary-configuration.adoc
...
The cluster definition includes commonly used cluster and node properties. To add other node properties, you can specify any node property in the xref:reference:node-configuration-sample.adoc[node configuration template] by using the `additionalConfiguration` property.
