...
:page-aliases: platform:features/kubernetes-connectivity.adoc, platform:deployment/kubernetes-connectivity.adoc, deployment:kubernetes-connectivity.adoc
...
NOTE: DNS configuration is not handled by the Redpanda operator.
