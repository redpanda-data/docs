...
:page-aliases: platform:features/kubernetes-external-connect.adoc, platform:deployment/kubernetes-connectivity.adoc, deployment:kubernetes-external-connect.adoc
