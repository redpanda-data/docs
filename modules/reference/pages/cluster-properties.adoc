...
Validation mode performed before recovering a topic from cloud storage. This property accept the following parameters:
...
Number of segment metadata to validate, from newest to oldest, when <<cloud_storage_recovery_topic_validation_mode>> is set to `check_manifest_and_segment_metadata`.
