...
Reserved partition slots on shard (CPU core) 0 on each node.  If this is greater or equals <<topic_partitions_per_core,`topic_partitions_per_core`>>, no data partitions will be scheduled on shard 0.
