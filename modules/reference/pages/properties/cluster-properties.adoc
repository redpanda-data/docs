...
`raft_election_timeout_ms` is the internal C++ variable name for this setting and is not a user-facing cluster property. The user-facing property is xref:#election_timeout_ms[`election_timeout_ms`].
