...
If `replication.factor` is set to a positive value, it overrides the cluster property xref:reference:properties/cluster-properties.adoc#default_topic_replications[default_topic_replications] for the topic.
