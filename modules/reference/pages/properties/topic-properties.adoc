...
| xref:./cluster-properties.adoc#initial_retention_local_target_bytes_defa
ult[`initial_retention_local_target_bytes_default`]
| <<initialretentionlocaltargetms,`initial.retention.local.target.ms`>>
| xref:./cluster-properties.adoc#initial_retention_local_target_ms_default
...
| xref:./cluster-properties.adoc#log_segment_size[`log_segment_size`] (or xref:./cluster-properties.adoc#compacted_log_segment_size[`compacted_log_segment_size`] for compacted topics)
