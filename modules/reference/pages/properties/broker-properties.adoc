...
redpanda:
  advertised_kafka_api:
    - address: external-broker-1.example.com
      port: 9092
    - address: external-broker-1.example.com
      port: 9093
      name: external_tls
...
----
redpanda:
  cloud_storage_cache_directory: /var/lib/redpanda/cloud_cache
----
...
----
redpanda:
  cloud_storage_inventory_hash_store: /var/lib/redpanda/inventory_hashes
----
...
redpanda:
  node_id_overrides:
    - current: "01234567-89ab-cdef-0123-456789abcdef"
      id: 5
