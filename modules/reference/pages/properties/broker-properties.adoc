...
All broker properties are configured as children of the `redpanda` section in your configuration file. Simple properties use a single key-value pair, while complex properties (such as listeners and TLS configurations) include examples.
