...
If both this property and <<cloud_storage_cache_size_percent>> are set, Redpanda uses the minimum of the two. If one of these properties is set to 0, Redpanda applies the non-zero value. If they are both set to 0, the cache size is 0.
