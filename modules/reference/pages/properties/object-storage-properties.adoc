...
The directory where the cache archive is stored. This property is mandatory when xref:./object-storage-properties.adoc#cloud_storage_enabled[cloud_storage_enabled] is set to `true`.
