...
- Azure: If you have enabled hierarchical namespaces for your storage account and use a custom domain, use <<cloud_storage_azure_adls_endpoint,`cloud_storage_azure_adls_endpoint`>>.
