...
A histogram of the latency in seconds of transforming a single record.
...
Total CPU Time (in seconds) spent inside a WebAssembly function
...
Max amount of memory for a WebAssembly function
