...
This enables an updated throttling algorithm based on a shared token bucket, introduced with Redpanda v23.3.8. Set this property to false if you need to use the quota balancing algorithm from Redpanda v23.3.7 and older. This defaults to true for all new or upgraded Redpanda clusters.
