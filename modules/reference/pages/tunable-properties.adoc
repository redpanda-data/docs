...
This disables version two of throughput throttling, introduced with Redpanda v23.3.8. When this is disabled, Redpanda uses the throttling mechanism from v23 and older. This defaults to true for all new or upgraded Redpanda clusters.
...
Threshold for refilling the token bucket. Will be clamped between 1 and rate.
