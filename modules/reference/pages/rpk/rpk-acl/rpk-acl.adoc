= rpk acl
:description: This command lets you create, list, and delete ACLs. It also lets you create SASL users.
:rpk_version: v23.2.1

Manage ACLs and SASL users.

This command creates, lists, and deletes ACLs. It also creates SASL
