...
If you're following the guide xref:get-started:quick-start.adoc[QuickStart -  Deploy Redpanda to Docker with Three Nodes], you can run `rpk container status` to see more information about your containers:
