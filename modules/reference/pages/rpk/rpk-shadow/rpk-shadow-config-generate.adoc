...
By default, this command creates a sample configuration file with placeholder values that you customize for your environment. If you are generating a Shadow Link for Redpanda Cloud, use the `--for-cloud` flag.
