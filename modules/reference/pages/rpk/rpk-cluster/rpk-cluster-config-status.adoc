...
Some cluster properties require a rolling restart when updated, and it can take several minutes for the update to complete. This command lists the long-running operations executed by the update and their status:
