...
**Note:** These are Schema Registry ACLs only. You also need Kafka ACLs for topics, consumer groups, and cluster operations. See xref:manage:security/authorization/acl.adoc[Configure Access Control Lists].
