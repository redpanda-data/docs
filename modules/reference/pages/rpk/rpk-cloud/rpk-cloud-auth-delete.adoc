...
If you delete an auth that is used by profiles, affected profiles have their auth cleared and you will only be able to access the profile's cluster via SASL credentials.
