...
* With the xref:production-deployment.adoc[Redpanda installation binary]
* With Ansible

== Installing Redpanda with Ansible

Whether you are using xref:production-deployment.adoc[bare-metal servers] or Terraform, you can use Ansible to install Redpanda.
